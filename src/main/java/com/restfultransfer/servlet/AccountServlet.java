...
public class AccountServlet {
    ...
    public Response SetActive(long accountId, boolean active) throws Exception {
    ...
    public Response Deactivate(@PathParam("accountId") long accountId) throws Exception {
    	return SetActive(accountId, false);
    }

    @PUT
    @Path("/{accountId}/activate")
    public Response Activate(@PathParam("accountId") long accountId) throws Exception {
